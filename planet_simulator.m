...
fig = figure(1);
whitebg(1,'k');
plot(time, absolute_positions(:,1), 'yo', ...
      time, absolute_positions(:,2), 'm.', ...
      time, absolute_positions(:,3), 'y*', ...
      time, absolute_positions(:,4), 'bo', ...
      time, absolute_positions(:,5), 'r.', ...
      time, absolute_positions(:,6), 'ro', ...
      time, absolute_positions(:,7), 'yo', ...
      time, absolute_positions(:,8), 'b*', ...
      time, absolute_positions(:,9), 'bo', ...
      time, absolute_positions(:,1), 'y', ...
      time, absolute_positions(:,2), 'm', ...
      time, absolute_positions(:,3), 'y', ...
      time, absolute_positions(:,4), 'b', ...
      time, absolute_positions(:,5), 'r', ...
      time, absolute_positions(:,6), 'r', ...
      time, absolute_positions(:,7), 'y', ...
      time, absolute_positions(:,8), 'b', ...
      time, absolute_positions(:,9), 'b');
