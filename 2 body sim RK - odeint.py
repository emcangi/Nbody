...
def solve_system(bodies, SCALE, AU):
    ...
    for body in bodies:
        for other in bodies:
            ...
            r = body.location
            v = body.velocity
            y0 = np.array([r[0], r[1], v[0], v[1]])
            
            Y = odeint(diffeqs, y0, times, args=(GMr3,))
            
            result_array = Y * SCALE       # don't forget to scale!
            all_body_data[body] = result_array
            
    return times, all_body_data
