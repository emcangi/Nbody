...
% Calculates GMd / d^3 component-wise between each mass and each other mass
...
% all the GMd_x/d^3 and GMd_y/d^3 terms for one object. So the first column 
% is the column where m1 is the "self" mass and so on.
all_dvx_dt = GMrx ./ d3;
all_dvy_dt = GMry ./ d3;
